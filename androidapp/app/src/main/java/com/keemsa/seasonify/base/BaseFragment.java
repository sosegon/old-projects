...
import com.keemsa.seasonify.injection.component.ActivityComponent;
import com.keemsa.seasonify.injection.component.ConfigPersistentComponent;
import com.keemsa.seasonify.injection.component.DaggerConfigPersistentComponent;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!sComponentsMap.containsKey(mFragmentId)) {
            ...
            configPersistentComponent = DaggerConfigPersistentComponent
                    .builder()
                    .applicationComponent(SeasonifyApplication.get(getContext()).getComponent())
                    .build();
